...
const en = {
  ...
  chatbot: {
    ...
    rateLimitDay: "Daily message limit reached. Please email contact@avsolutions.dev instead.",
...
const bg: typeof en = {
  ...
  chatbot: {
    ...
    rateLimitDay: "Достигнат е дневният лимит за съобщения. Моля, пишете на contact@avsolutions.dev.",
...
const de: typeof en = {
  ...
  chatbot: {
    ...
    rateLimitDay: "Tageslimit für Nachrichten erreicht. Bitte schreiben Sie an contact@avsolutions.dev.",
